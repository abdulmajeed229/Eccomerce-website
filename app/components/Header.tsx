...
<header className='flex bg-white border-b py-3 sm:px-6 px-4  min-h-[75px] tracking-wide relative z-50 sticky top-0'>
      <div className='flex max-w-screen-xl mx-auto w-full'>
        <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
      
         <Link href={"/"}>
            <h1 className="text-black text-[20px] font-bold">Exclusive</h1>
            </Link>
...
<Link href="/sign-up">
              <li className='max-lg:border-b max-lg:py-3 px-3'><a href=''
                className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Sign Up</a></li>
          ...
          <div className="flex items-center gap-x-6 gap-y-4 ml-auto">
            <div
              className='flex bg-gray-50 border focus-within:bg-transparent focus-within:border-gray-200 rounded px-4 py-2.5 overflow-hidden min-w-[260px] max-lg:hidden'>
            ...
            <div className="flex flex-col items-center justify-center gap-0.5 cursor-pointer">
               ...
               <Link href="/cart">   <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="cursor-pointer fill-[#333] inline"
                    viewBox="0 0 512 512">
                    <path
